...
function Topbar() {
  return (
    <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-slate-800 bg-slate-950/95 px-4 backdrop-blur md:px-6">
      <div>
        <p className="text-xs text-slate-500">Medical Imaging</p>
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-2 rounded-lg p-2 text-slate-300 transition hover:bg-slate-900">
          <User size={19} />
